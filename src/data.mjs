...
export const PEOPLE = [
  {
    id: "chenye", name: "陈野", role: "后端工程师", city: "上海", mode: "线上", avatar: "陈", color: "blue",
  ...
  {
    id: "songran", name: "宋然", role: "自由摄影师", city: "杭州", mode: "线上", avatar: "宋", color: "orange",
  ...
  {
    id: "mia", name: "Mia", role: "留学顾问", city: "上海", mode: "均可", avatar: "M", color: "pink",
  ...
  {
    id: "zhouyuan", name: "周予安", role: "独立音乐人", city: "南京", mode: "线上", avatar: "周", color: "green",
  ...
  {
    id: "xuyi", name: "许一", role: "产品设计师", city: "北京", mode: "线上", avatar: "许", color: "violet",
  ...
  {
    id: "aluo", name: "阿洛", role: "短视频编导", city: "广州", mode: "线上", avatar: "洛", color: "yellow",
