...
export function createInitialState() {
  return {
    ...
    assignments: [{ id: "homework-1", title: "写一个文件自动分类脚本", criteria: "按扩展名整理至少 3 类文件，并保留运行截图", course: "Python 自动化 · 第 1 次", due: "下次课前", partnerId: "chenye", partnerName: "陈野", status: "待确认", done: false }],
    posts: [
